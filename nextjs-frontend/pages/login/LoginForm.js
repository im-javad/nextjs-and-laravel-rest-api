...
const LoginForm = () => {
  ...
  return (
    <div className="relative flex flex-col p-7 items-center justify-center overflow-hidden">
      <div className="w-full p-6 rounded-md shadow-md lg:max-w-xl shadow-lg shadow-cyan-500/50">
        <h1 className="text-3xl font-bold text-center text-cyan-500">Login</h1>

        <form className="mt-6" autoComplete="off" onSubmit={submitOperatoin}>
          <div className="mb-4">
            <label
              htmlFor="email"
